      ...
      <div className="w-full max-w-md animate-in fade-in zoom-in-95 duration-300">
        <div className="flex justify-center mb-8">
          <div className="flex items-center gap-2">
            ...
            <span className="font-mono font-bold tracking-tight text-2xl text-primary">SCRIPT_HUB</span>
          </div>
        </div>
        
        <Card className="bg-card border-border/50 shadow-xl shadow-primary/5">
