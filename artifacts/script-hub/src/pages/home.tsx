...
function HeroGraphic() {
  return (
    ...
    <div className="anim-float w-full h-full">
      <svg
        viewBox="0 0 600 500"
        fill="none"
      ...
      >
        ...
        {/* Scan line moving through the graphic */}
        <rect
          x="210" y="80" width="180" height="200"
          fill="#ef4444"
          fillOpacity="0.04"
          className="anim-scan"
        ...
        <ellipse
          cx="300" cy="180" rx="70" ry="20"
          stroke="#dc2626" strokeWidth="1" strokeOpacity="0.35"
          fill="none" strokeDasharray="6 4"
          className="anim-orbit"
          style={{ transformOrigin: '300px 180px', animationDuration: '18s' }}
        />

        {/* Vertical orbit ring */}
        <ellipse
          cx="300" cy="180" rx="20" ry="70"
          stroke="#dc2626" strokeWidth="1" strokeOpacity="0.25"
          fill="none" strokeDasharray="4 6"
          className="anim-orbit-rev"
          style={{ transformOrigin: '300px 180px', animationDuration: '26s' }}
        />
        ...
        <circle
          cx="300" cy="180" r="38"
          stroke="#ef4444" strokeWidth="1.5" strokeOpacity="0.5"
        ...
        <circle
          ...
          style={{ transformOrigin: '300px 180px' }}
        />
        <circle cx="300" cy="180" r="10" filter="url(#blur2)" fill="#ef4444" fillOpacity="0.5" />

        {/* Satellite dots — twinkle at staggered delays */}
        <circle cx="370" cy="180" r="4" fill="#ef4444" fillOpacity="0.9"
          className="anim-twinkle" style={{ animationDelay: '0s' }} />
        <circle cx="370" cy="180" r="6" fill="#ef4444" fillOpacity="0.15" filter="url(#blur2)" />

        <circle cx="230" cy="180" r="3" fill="#dc2626" fillOpacity="0.8"
          className="anim-twinkle" style={{ animationDelay: '0.8s' }} />

        <circle cx="300" cy="250" r="4" fill="#ef4444" fillOpacity="0.85"
          className="anim-twinkle" style={{ animationDelay: '1.5s' }} />

        <circle cx="300" cy="110" r="3" fill="#dc2626" fillOpacity="0.7"
          className="anim-twinkle" style={{ animationDelay: '2.2s' }} />
        ...
        {/* Corner hex nodes */}
        <polygon points="520,40 548,55 548,85 520,100 492,85 492,55"
          stroke="#dc2626" strokeOpacity="0.4" strokeWidth="1"
          fill="#dc2626" fillOpacity="0.03" />
        <circle cx="520" cy="70" r="8" fill="#ef4444" fillOpacity="0.5"
          className="anim-twinkle" style={{ animationDelay: '0.4s' }} />

        <polygon points="80,340 108,355 108,385 80,400 52,385 52,355"
          stroke="#dc2626" strokeOpacity="0.3" strokeWidth="1"
          fill="#dc2626" fillOpacity="0.02" />
        <circle cx="80" cy="370" r="6" fill="#ef4444" fillOpacity="0.4"
          className="anim-twinkle" style={{ animationDelay: '1.1s' }} />

        {/* Floating code panels */}
        <rect x="440" y="290" width="60" height="36" rx="4"
          stroke="#dc2626" strokeOpacity="0.4" strokeWidth="1" fill="#dc2626" fillOpacity="0.04" />
        ...
        <rect x="90" y="170" width="60" height="36" rx="4"
          stroke="#dc2626" strokeOpacity="0.35" strokeWidth="1" fill="#dc2626" fillOpacity="0.04" />
        ...
        <rect x="200" y="350" width="60" height="36" rx="4"
          stroke="#dc2626" strokeOpacity="0.3" strokeWidth="1" fill="#dc2626" fillOpacity="0.03" />
        ...
        {/* Corner crosshairs */}
        {[[50,50],[550,50],[50,450],[550,450]].map(([cx,cy]) => (
          <g key={`cross-${cx}-${cy}`}>
        ...
        {/* Scatter dots */}
        {[
          [140,80,2.5,0.5,0],[460,150,2,0.4,0.6],[380,400,2.5,0.45,1.2],
          [100,290,1.5,0.35,1.8],[530,320,2,0.4,0.3],[240,430,1.5,0.3,2.1],
          [490,230,2,0.45,0.9],[160,340,1.5,0.3,1.5],
        ].map(([x,y,r,o,delay]) => (
          <circle key={`dot-${x}-${y}`} cx={x} cy={y} r={r} fill="#ef4444" fillOpacity={o}
            className="anim-twinkle" style={{ animationDelay: `${delay}s` }} />
        ))}
      </svg>
    </div>
  );
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col font-sans">
      ...
      <div className="relative overflow-hidden border-b border-border/50">
        ...
        <div className="container mx-auto px-4 grid md:grid-cols-2 items-center gap-8 py-16 md:py-20">
          ...
          <div className="flex flex-col space-y-5 z-10">
            <div className="anim-fade-up delay-100 flex items-center gap-2 text-primary font-mono text-xs font-bold tracking-widest uppercase">
              <span className="w-8 h-px bg-primary inline-block" />
              The Underground Collection
            </div>
            <h1 className="anim-fade-up delay-200 text-5xl md:text-6xl font-extrabold tracking-tight leading-tight">
              Dark <span className="text-primary font-mono">Alliance</span>
              <br />Scripts
            </h1>
            <p className="anim-fade-up delay-300 text-muted-foreground text-base max-w-sm">
              Premium scripts handpicked for serious players. Grab what you need, dominate what you play.
            </p>
            {stats && (
              <div className="anim-fade-up delay-400 flex gap-3 text-xs font-mono text-muted-foreground pt-1">
                <span className="bg-secondary border border-border/50 px-3 py-1.5 rounded transition-colors duration-200 hover:border-primary/40">
                  [{stats.totalPublished}] SCRIPTS
                </span>
                <span className="bg-secondary border border-border/50 px-3 py-1.5 rounded transition-colors duration-200 hover:border-primary/40">
          ...
          {/* Vector graphic */}
          <div className="anim-fade-in delay-200 relative h-72 md:h-96 flex items-center justify-center">
            <HeroGraphic />
          </div>
        </div>
      </div>
      ...
      <section className="flex-1 container mx-auto px-4 py-10">
        {/* Search + filters — fade up */}
        <div className="anim-fade-up delay-100 flex flex-col md:flex-row gap-4 mb-8">
          <div className="relative flex-1">
            <Search className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" />
            <Input
              placeholder="Search scripts..."
              data-testid="input-search"
              className="pl-9 font-mono bg-card border-border focus-visible:ring-primary/50 transition-shadow duration-200"
              value={search}
          ...
          <div className="flex flex-wrap gap-2">
            <Badge
              ...
              className="cursor-pointer font-mono transition-all duration-150 hover:scale-105 active:scale-95"
        ...
        {scriptsLoading ? (
          ...
          <div className="anim-fade-up text-center py-24 border border-dashed border-border rounded-lg bg-card/50">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {scripts?.map((script, index) => (
              <Card
                ...
                className="bg-card border-border/50 hover:border-primary/60 transition-all duration-300 hover:shadow-[0_0_24px_rgba(220,38,38,0.15)] hover:-translate-y-1 group flex flex-col"
                style={{
              ...
              >
                ...
                <CardFooter>
                  <Button
                    className="w-full font-mono font-bold tracking-tight bg-primary text-primary-foreground hover:bg-primary/85 btn-press transition-all duration-150"
                    asChild
